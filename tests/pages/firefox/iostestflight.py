...
class iOSTestFlightPage(FirefoxBasePage):
    ...
    _lastname_locator = (By.ID, 'id_last_name')
    ...
    _submit_button_locator = (By.ID, 'testflight-submit')
    ...
    _thank_you_locator = (By.CSS_SELECTOR, '#testflight-form-thankyou h2')
    ...
    def type_firstname(self, value):
        self.find_element(self._firstname_locator).send_keys(value)

    def type_lastname(self, value):
        self.find_element(self._lastname_locator).send_keys(value)
